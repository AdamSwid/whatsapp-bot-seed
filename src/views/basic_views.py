...
NEGRO_MODE = ('Bring dem fuckin rockets to dat ass', 'Bend that bitch like beckham', 'I dont fuck around',
...
class BasicViews():
    ...
    def negro_mode(self, message, match):
        MESSAGE = NEGRO_MODE[randint(0, len(NEGRO_MODE) -1)]
        if randint(0,9) == 1:
